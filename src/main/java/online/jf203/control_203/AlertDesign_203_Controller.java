...
public class AlertDesign_203_Controller {
    ...
    Boolean coldsite_alert = true;//冷通道波动报警
...
//        find_list.allEq(null);
        ...
        String sql_penultimate = "select * from realdata_once where Location='JF203' and Equipment='服务器' and PointName='冷通道温度'  and time = ( SELECT time FROM realdata_once order by time desc limit 1 OFFSET 2000)"; //60数据间隔
